...
//constants
int Roff=200;// Max temp resistance
...
cycle();
 ...
 // Rup=Ru;
  ...
  myOLED.print( i2_test    ,   OLED_R, 4);  
  myOLED.print( "     "    ,   OLED_C, 5);
  myOLED.print( TD    ,   OLED_C, 5);  
  i2_test++;
...
//  myOLED.print("    ",OLED_C,2);
 ...
 //chenge_fl=0;
// tpon_fl=0; 
myOLED.print(TS1,OLED_L,5);
        myOLED.print(TS0,OLED_R,5);
    }
  }while(TD<T);
  }
