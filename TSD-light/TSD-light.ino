...
unsigned char encoder_A, encoder_B, encoder_A_prev,kb1; // valcoder
...
myOLED.print(Ru, OLED_L, 4);
myOLED.print(t1, OLED_C, 4);
dR=abs(Ru-Rt);
...
{
  tim=millis()-tim1;
  float t1=thermocouple.readCelsius();
  t2=floor(t1);
