...
byte recfl=0;
struct dat{byte i;byte io; byte tem; int tim;};  //recording data
dat d;
//dat d1;
int t;//temproary
int tmin;  //stat
...
int del=30000; // mesure delay

void setup() {
  // put your setup code here, to run once:
Serial.begin(9600);//i=findi();
pinMode(ld,OUTPUT);
